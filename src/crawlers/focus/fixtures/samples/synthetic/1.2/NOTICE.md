# NOTICE — synthetic FOCUS 1.2 sample data
...
42, 60 rows, 57 columns matching FOCUS 1.2's
`data/focus/1.2/columns.json` column list exactly. Re-running the
...
1.2) — see `src/shared/focus/synthetic.test.ts`. For the official
