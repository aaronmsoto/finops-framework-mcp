...
license: CC-BY-4.0
slug: sustainability
source_url: https://www.finops.org/framework/capabilities/sustainability/
...
- Training and guidance to help all relevant FinOps Personas understand how to manage, view, and act on sustainability data at the appropriate level of granularity (e.g. by team, application, workload, or technology domain)
...
### Percentage of CSP Cloud Carbon that is Tagging Policy Compliant {wp_id=17866}
...
### Carbon Waste / Carbon Efficiency {wp_id=17890}
...
### Carbon per Unit of Cloud Service SKU {wp_id=17882}
...
### Carbon per Unit of Cloud Spend {wp_id=17871}
...
- Carbon consumption data source,
- CSP Billing data,
- CSP FOCUS files
