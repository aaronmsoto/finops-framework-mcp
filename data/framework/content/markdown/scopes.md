...
[Framework Overview](https://www.finops.org/framework/) / FinOps Scopes 
...
- Elements of the FinOps Framework such as Personas, Domains, and Capabilities serve as foundational building blocks for FinOps Scopes.
...
- A common set of FinOps Capabilities, Personas, and Domains can often be applied across Scopes with minimal variation.
...
A common trigger may be a question such as, “*What are we spending on AI?*” While this suggests that greater visibility is needed, the FinOps practitioner’s role is to understand why the information is being requested and what outcome the business is trying to achieve.

 

Techniques such as the Five whys can be used to draw out this context and avoid delivering an answer that is technically correct but strategically unhelpful.
...
Leadership: *What are we spending on AI?*
...
Leadership: *We want to understand how Team A and Team B are using AI.*
...
Leadership: *We need to ensure we’re investing in the right types of AI infrastructure in the right places to support our key product teams.*
...
Leadership: *We want these products to drive innovation using AI to differentiate us.*
...
Leadership: *We want to stay ahead of competitors in AI adoption and grow market share.*
...
###### Related Assets
 ...
 [FinOps for AI Overview](https://www.finops.org/wg/finops-for-ai-overview/) [Model Context Protocol (MCP): An AI for FinOps Use Case](https://www.finops.org/wg/model-context-protocol-mcp-ai-for-finops-use-case/) [<img width="64" height="35" class="rounded-xs" src="https://www.finops.org/wp-content/uploads/2025/03/FinOps-Assets-Paper-FinOps-for-GenAI-v1-1.png" alt="padded"> Driving Cost Efficiency into AI Deep Learning Pipelines with FinOps](https://www.finops.org/assets/driving-cost-efficiency-into-ai-deep-learning-pipelines-with-finops/) [<img width="64" height="36" class="rounded-xs" src="https://www.finops.org/wp-content/uploads/2025/03/Introduction-to-FinOps-for-SaaS-Featured-V1a.png" alt="padded"> Introduction to FinOps for SaaS](https://www.finops.org/wg/finops-for-software-as-a-service-saas/) [<img width="64" height="36" class="rounded-xs" src="https://www.finops.org/wp-content/uploads/2024/10/Under-Armour_Avalara-Breakout-size-v1.png" alt="padded"> Applying the FinOps Framework to SaaS at Scale](https://www.finops.org/assets/applying-the-finops-framework-to-saas-at-scale/) [<img width="64" height="36" class="rounded-xs" src="https://www.finops.org/wp-content/uploads/2023/09/expedia-x23.png" alt="padded"> How FinOps Tools and Practices Can Help Control Licensing and Other Costs (Expedia Group)](https://www.finops.org/assets/how-finops-tools-and-practices-can-help-control-licensing-and-other-costs-expedia-group/) [<img width="64" height="36" class="rounded-xs" src="https://www.finops.org/wp-content/uploads/2025/03/FinOps-Assets-Paper-Effect-of-Optimization-on-AI-Forecasting-Featured-v1.png" alt="padded"> Effect of Optimization on AI Forecasting](https://www.finops.org/wg/effect-of-optimization-on-ai-forecasting/) [<img width="64" height="36" class="rounded-xs" src="https://www.finops.org/wp-content/uploads/2025/05/Context-for-Creating-a-FinOps-Practice-Profile-Featured-V1.png" alt="padded"> FinOps Considerations for a Data Center](https://www.finops.org/wg/finops-for-data-center-creating-a-finops-practice-profile/) [<img width="64" height="36" class="rounded-xs" src="https://www.finops.org/wp-content/uploads/2025/08/FinOps-Assets-Paper-FinOPs-for-Data-Clouds-Featured-v2.png" alt="padded"> Context for Building a FinOps Practice for Data Cloud Platforms](https://www.finops.org/wg/finops-data-cloud-platforms/)
...
- [FinOps Foundation Insights](https://www.finops.org/insights/)
- [FinOps Landscape](https://www.finops.org/landscape/)
- [Cloud FinOps Book](https://www.finops.org/community/finops-book/)
- [What’s New in FinOps](https://www.finops.org/updates/)

## Get Involved

[<img width="720" height="405" class="mr-3 w-[38%]" src="https://www.finops.org/wp-content/uploads/2024/07/FinOps-Individual-Thumbnail-v1.png" alt=""> Join as an Individual](https://www.finops.org/membership/)[<img width="720" height="405" class="mr-3 w-[38%]" src="https://www.finops.org/wp-content/uploads/2024/07/FinOps-Enterprise-Thumbnail-v1.png" alt=""> Join as an Enterprise](https://www.finops.org/membership/enterprise/)
...
Back to menu[About](https://www.finops.org/about/) 
...
#### Get Involved
   ...
   [<img width="720" height="405" class="mr-3 w-12" src="https://www.finops.org/wp-content/uploads/2024/07/FinOps-Individual-Thumbnail-v1.png" alt=""> Join as an Individual](https://www.finops.org/membership/) [<img width="720" height="405" class="mr-3 w-12" src="https://www.finops.org/wp-content/uploads/2024/07/FinOps-Enterprise-Thumbnail-v1.png" alt=""> Join as an Enterprise](https://www.finops.org/membership/enterprise/)
